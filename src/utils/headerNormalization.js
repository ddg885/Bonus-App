const aliases = {
  ...
  mbrreservebonussubminstalleffectivedate: 'effectiveDate',
  ...
  mbrreservebonussubmcode: 'rawTypeCode',
  mbrreservebonussubmtype: 'bonusType',
  mbrreservebonussubmtypecode: 'rawTypeCode',
  mbrreservebonussubmtracknumactual: 'trackNumActual',
  memberpaygrade: 'paygrade',
  memberofficerdesignator: 'officerDesignator',
  mbrreservebonussubmraterank: 'rateRank',
  mbrreservebonussubmnec: 'nec',
  reserveuicindicator: 'reserveUicIndicator',
  paygrade: 'paygrade',
  uicreserveuicindicator: 'uic',
  uic: 'uic',
  typecode: 'rawTypeCode',
  bonustypecode: 'rawTypeCode',
